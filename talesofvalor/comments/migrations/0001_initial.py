    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'characters'), ('model', 'Character')), models.Q(('app_label', 'events'), ('model', 'Event')), models.Q(('app_label', 'attendance'), ('model', 'Attendance')), models.Q(('app_label', 'betweengameskills'), ('model', 'BetweenGameSkill')), models.Q(('app_label', 'origins'), ('model', 'Origin')), models.Q(('app_label', 'players'), ('model', 'Player')), models.Q(('app_label', 'skills'), ('model', 'Header')), models.Q(('app_label', 'skills'), ('model', 'Skill')), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
